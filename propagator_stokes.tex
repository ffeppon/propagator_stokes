...
\[
    \tau[\pphi](x_1,x'):=\pphi\circ \tau_{x_1}(x_1,x')=\phi(x_1+1,x'),    
\]                        %
where the argument and ima%ge spaces will be clear from the context. 
\begin{definition}        %
    ...
    \begin{aligned}
        ...
        & \v_0 &  \mapsto & (\mathcal{V}[\v_0])|_{\Gamma_1}\circ \tau_{x_1}^{-1},
    \end{aligned}
    \end{equation}
